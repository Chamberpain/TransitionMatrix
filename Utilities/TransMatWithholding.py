...
from TransitionMatrix.Utilities.TransGeo import TransitionGeo,SOSEGeo,SummerGeo,WinterGeo,SummerSOSEGeo,WinterSOSEGeo,ARGOSGeo,GPSGeo,WithholdingGeo,SOSEWithholdingGeo
import numpy as np
import copy
import random
from TransitionMatrix.Utilities.Utilities import matrix_size_match,matrix_compare
			...
			for k in range(50):
				for coord in coord_list:
					for time_step in [30,60,90]:
						...
						datalist.append(matrix_compare(base_mat,withholding_mat,(base_traj_class.file_type,percentage),absolute_value=False))
