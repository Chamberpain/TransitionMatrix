...
pcm = ax1.pcolormesh(XX,YY,-current_dist_array,cmap=cmap,vmin=-2,vmax=2,zorder=-10)
...
ax2.pcolormesh(XX,YY,-one_year_dist_array,cmap=cmap,vmin=-2,vmax=2,zorder=-10)
