...
def matrix_difference_compare(matrix_1,matrix_2):
    ...
    l2_residual = (matrix_1-matrix_2)*(matrix_1-matrix_2)
    traj_1 = matrix_1.trans_geo
    traj_2 = matrix_2.trans_geo
    return ((traj_1.lat_sep,traj_1.lon_sep,traj_1.time_step,traj_1.file_type),
        (traj_2.lat_sep,traj_2.lon_sep,traj_2.time_step,traj_2.file_type),
        q,l2_residual.mean(),l2_residual.data.std())

def matrix_size_match(matrix_1,matrix_2):
    matrix_1_set = set(matrix_1.trans_geo.tuple_total_list())
    matrix_2_set = set(matrix_2.trans_geo.tuple_total_list())
