...
def matrix_compare(matrix_1,matrix_2,description,absolute_value=True):
	east_west_lr, north_south_lr = matrix_1.return_mean()
	east_west_lr = matrix_1.trans_geo.transition_vector_to_plottable(east_west_lr)
	north_south_lr = matrix_1.trans_geo.transition_vector_to_plottable(north_south_lr)
	...
	if absolute_value:
		...
		ew_mean_diff = (east_west_lr-east_west_hr).mean()
		ns_mean_diff = (north_south_lr-north_south_hr).mean()
		ew_std_diff = (ew_std_lr-ew_std_hr).mean()
		ns_std_diff = (ns_std_lr-ns_std_hr).mean()
