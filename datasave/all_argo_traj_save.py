...
"""This file recursively searches the ifremer DAC for traj files and makes a list for download. After 
I wrote this, I learned that there is a list maintained on the server of this exact thing, so it is 
essentially a waste. I will save this for posterity in case I need a similar script again"""
